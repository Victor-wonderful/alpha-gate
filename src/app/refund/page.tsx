  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>해당 월 분석 횟수의 절반 이상을 이미 사용한 경우</li>
      </ul>
      ...
      <p>5월 1일 Standard 월 ₩15,000 결제 → 5월 5일 환불 요청 → <strong>₩15,000 전액 환불</strong></p>
      <h3>예시 2 — 결제 후 한 달 사용</h3>
      <p>
        Pro 월 ₩95,000 결제 → 분석 횟수의 60% 사용 후 환불 요청 → 8일 이후이므로 일할 환불 대상이 아님.
        다만 서비스 장애로 정상 이용이 불가했다면 일할 환불 적용.
      </p>
