  ...
  return (
    <footer className="bg-black">
      <div className="mx-auto max-w-6xl px-6 py-16 sm:px-10">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-xs leading-relaxed text-white/50">
              Alpha Gate는{" "}
              <strong className="text-white">투자 자문이 아닙니다</strong>. 본 서비스는 매매 의사결정 점검 도구이며, 모든 매매 결정과 결과는 사용자 본인의 책임입니다.
            </p>
            <div className="mt-4">
              <a
        ...
        <div className="mt-16 border-t border-white/10 pt-6 text-center text-[10px] uppercase tracking-[0.2em] text-white/30">
