...
const PAIRS: { symbol: string; upbit: string; binance: string }[] = [
  ...
  { symbol: "OP", upbit: "KRW-OP", binance: "OPUSDT" },
  ...
  { symbol: "FIL", upbit: "KRW-FIL", binance: "FILUSDT" },
  ...
  { symbol: "AAVE", upbit: "KRW-AAVE", binance: "AAVEUSDT" },
  { symbol: "UNI", upbit: "KRW-UNI", binance: "UNIUSDT" },
  { symbol: "SAND", upbit: "KRW-SAND", binance: "SANDUSDT" },
  { symbol: "MANA", upbit: "KRW-MANA", binance: "MANAUSDT" },
  { symbol: "AXS", upbit: "KRW-AXS", binance: "AXSUSDT" },
