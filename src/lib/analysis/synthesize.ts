...
- liquidity_grab: 손절폭이 스타일 하한 미만이어도 허용 (sweep 직전 wickExtreme이 자연 손절). 단 0.24% 미만은 절대 금지. R:R ≥ 2.5 필수. qualityIssues에 "특수 셋업: 손절 좁음 — 리스크% 평소 절반 권장" 추가.
- funding_squeeze: 스타일 범위 그대로 적용. R:R ≥ 2 필수. warning에 "시간 한도 12~24h" 필수.
- session_open_drive: 데이 표준의 절반 손절폭까지 허용 (개장 캔들 시가가 자연 손절). 단 0.24% 미만은 절대 금지. qualityIssues에 "개장 드라이브 — 미국 마감 전 청산" 추가.
